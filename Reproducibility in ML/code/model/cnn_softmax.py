...
class CNN:
    ...
    def train(self, checkpoint_path, epochs, log_path, train_data, test_data):
        ...
        with tf.Session() as sess:
            ...
            ax1.plot(index_axis,train_acc)
            ax2.plot(index_axis,train_losses)
            fig1.savefig('train_acc_softmax.png')
            fig2.savefig('train_lose_softmax.png')
            ...
            print("Average Training Loss: {}".format(sum(train_losses)/len(train_losses)))
            print("Average Training Accuracy: {}".format(sum(train_acc)/len(train_acc)))
